# Script:     Plot 1 for Exploratory Data Analysis - Project 1
...
hist(dataToUse$Global_active_power, xlab = "Global Active Power (kilowatts)", main = "Global Active Power", col = "red")
dev.off()
