# Script:     Plot 4 for Exploratory Data Analysis - Project 1
...
plot(x = dataToUse$DateTime, y = dataToUse$Global_active_power, type = "l", xlab = "", ylab = "Global Active Power (kilowatts)")
plot(x = dataToUse$DateTime, y = dataToUse$Voltage, type = "l", xlab = "datetime", ylab = "Voltage")
...
plot(x = dataToUse$DateTime, y = dataToUse$Global_reactive_power, type = "l", xlab = "datetime", ylab = "Global_reactive_power")
dev.off()
